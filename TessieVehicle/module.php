...
class TessieVehicle extends IPSModule
{
    ...
    private function translateTelemetryKey(string $key): string
    {
        ...
        $map = [
            ...
            'LifetimeEnergyUsed' => 'Energieverbrauch gesamt (kWh)',
            'ACChargingPower' => 'AC Ladeleistung (kW)',
            'DCChargingPower' => 'DC Ladeleistung (kW)',
            'ChargeAmps' => 'Ladestrom Ist (A)',
            'ChargeCurrentRequest' => 'Ladestrom Soll (A)',
            'ChargeCurrentRequestMax' => 'Ladestrom Max (A)',
            'ChargeLimitSoc' => 'Ladelimit (%, Ziel)',
