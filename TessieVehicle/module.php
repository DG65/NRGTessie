...
class TessieVehicle extends IPSModule
{
    ...
    private function ensureLinkTree(bool $forceRename = false): void
    {
        ...
        $domain = [
            self::PURPOSE_CHARGING => [self::ACT_START_CHARGING, self::ACT_CHARGE_LIMIT, self::ACT_CHARGING_AMPS_REQUEST, self::STAT_CHARGING_AMPS_ACTUAL, self::STAT_CHARGING_AMPS_MAX, self::STAT_AC_CHARGING_POWER],
