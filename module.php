...
class TessieVehicle extends IPSModule
{
    ...
    {
        // Wichtig: Telemetrie-Einträge werden im Formular zwar angezeigt, aber nicht automatisch in die Property gespeichert.
        // Daher hier zuerst Telemetrie-Registry in die Liste mergen, dann umschalten und speichern.
